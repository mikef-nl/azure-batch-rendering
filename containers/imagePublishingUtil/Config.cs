...
namespace PublishContainerImages
{
    ...
    [Verb("buildPublishStorage", HelpText = "Build and Publish the images to a Container Registry, using binaries from a storage container.")]
    class BuildPublishStorage : OptionsBase
    {
        ...
        [Option(Required = true)] public string StorageAccountName { get; set; }

        [Option(Required = true)] public string StorageContainerName { get; set; }
    ...
    [Verb("buildPublishLocal", HelpText = "Build and Publish the images to a Container Registry, using binaries from the local filesystem.")]
    class BuildPublishLocal : OptionsBase
    {
        [Option(Required = true)] public string TargetRelativeDirs { get; set; }
    ...
    [Verb("buildMetadataTestPublishMCR", HelpText = "Build, generate Tests and Metadata, and Publish the images to MCR pre-prod Container Registry.")]
    class BuildMetadataTestPublishMcrOptions : OptionsBase
    {
        [Option(Required = true)] public string TargetRelativeDirs { get; set; }
