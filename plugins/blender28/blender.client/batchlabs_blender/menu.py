...
class BATCH_LABS_MT_Submit_Menu(bpy.types.Menu):
    """
...
class BATCH_LABS_MT_BlenderMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        self.layout.operator(Constants.OP_ID_DOWNLOAD_RENDERS, text="Manage Data", icon = 'NEWFOLDER')
        self.layout.operator(Constants.OP_ID_MONITOR_JOBS, text="Monitor Jobs", icon = 'ZOOM_ALL')
        self.layout.operator(Constants.OP_ID_MONITOR_POOLS, text="Monitor Pools", icon = 'ZOOM_ALL')
